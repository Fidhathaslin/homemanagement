<div class="md:block hidden w-full leading-0">
    <button
        ...
        <div class="lg:h-8 lg:w-8 h-7 w-7 rounded-full flex-1 ltr:mr-[10px] rtl:ml-[10px]">
            <img class="block w-full h-full object-cover rounded-full"
                src="{{ auth()->user()->getFirstMediaUrl('user-profile-picture') }}" alt="user" />
        </div>
    ...
    <div
        ...
        <ul class="py-1 text-sm text-slate-800 dark:text-slate-200"
            :class="listView ? 'z-20 opacity-100 top-[61px]' : 'opacity-0 -z-20 top-5'" x-show="listView"
            @click.away="listView = false">
            <li>
            ...
            <li>
                <a href="/"
                    ...
                    @class([
                        'country-list',
                        'active' => request()->routeIs('general-settings.edit'),
                    ])>
