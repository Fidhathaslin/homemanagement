<x-app-layout>
    <div>
        ...
        {{-- Financial Year Edit Form start --}}
        <form method="POST" action="{{ route('financial-years.update', $financialYear->id) }}" class="max-w-4xl m-auto">
            @csrf
            @method('PATCH')
