<x-app-layout>
    <div>
        ...
        {{-- Bank Account Create Form start --}}
        <form method="POST" action="{{ route('bank-accounts.store') }}" class="max-w-4xl m-auto">
            @csrf
            ...
            <div class="bg-white dark:bg-slate-800 rounded-md p-5 pb-6">
                <div class="grid sm:grid-cols-2 gap-x-8 gap-y-4">
                    ...
                    <div class="input-area">
                        ...
                        <input type="text" name="passbook_number" id="passbook_number" class="form-control" value="{{ old('passbook_number') }}">
                    ...
                    <div class="input-area">
                        ...
                        <input type="text" name="currency" id="currency" class="form-control" value="{{ old('currency', 'QAR') }}">
                    ...
                    <div class="input-area">
                        ...
                        <input type="text" name="account_type" id="account_type" class="form-control" value="{{ old('account_type') }}">
                    ...
                    <div class="input-area">
                        ...
                        <input type="date" name="passbook_issue_date" id="passbook_issue_date" class="form-control" value="{{ old('passbook_issue_date') }}">
